...
- [Coding Interview University](#coding-interview-university)
  ...
  - [Lista de libros](#lista-de-libros)
    - [Preparación para la entrevista](#preparación-para-la-entrevista)
    - [Arquitectura de Computadores](#arquitectura-de-computadores)
    - [Específicos del lenguaje](#específicos-del-lenguaje)
    - [C++](#c)
    - [Java](#java)
    - [Python](#python)
    - [Libros Opcionales](#libros-opcionales)
  - [Antes de iniciar](#antes-de-iniciar)
    - [1. No recordará todo](#1-no-recordará-todo)
    - [2. Use tarjetas para recordar](#2-use-tarjetas-para-recordar)
    - [3. Revise, revise, revise](#3-revise-revise-revise)
    - [4. Enfóquese](#4-enfóquese)
  ...
  - [Practica de preguntas de programación](#practica-de-preguntas-de-programación)
  - [Ejercicios de programación/Desafíos](#ejercicios-de-programacióndesafíos)
  - [Una vez cerca de la entrevista](#una-vez-cerca-de-la-entrevista)
  - [Su CV (Currículum Vitae)](#su-cv-currículum-vitae)
